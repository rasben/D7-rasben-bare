...
/*
  ...
  Written in settings_secret.php
...
/**
 * Secret settings file for local development and production.
 *
 * The prod file should NEVER be committed to version control and should never exist
 * on anything but the production server.
 */
if (file_exists('./' . conf_path() . '/settings_prod.php')) {
  require './' . conf_path() . '/settings_prod.php';
}
else if (file_exists('./' . conf_path() . '/settings_dev.php')) {
  require './' . conf_path() . '/settings_dev.php';
}
